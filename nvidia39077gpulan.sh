...
# nvidia39077gpulan.sh
# Michael McMahon
# This script installs proprietary NVIDIA drivers 390.77 and CUDA toolkit
# for GPU video output.

# To run this script, boot into your GNU/Linux distro with runlevel 2 or 3.
# Follow these instructions:
# Run this script with:
# sudo bash nvidia39077gpulan.sh
# OR
# su
# bash nvidia39077gpulan.sh
# OR
# sudo chmod 755 nvidia39077gpulan.sh
# sudo ./nvidia39077gpulan.sh
# OR
# su
# chmod 755 nvidia39077gpulan.sh
# ./nvidia39077gpulan.sh
...
wget -q ftp://10.12.17.15/pub/software/drivers/nvidia/NVIDIA-Linux-x86_64-390.77.run
# wget -q http://us.download.nvidia.com/XFree86/Linux-x86_64/390.77/NVIDIA-Linux-x86_64-390.77.run
...
# installer.
#   sh NVIDIA-Linux-x86_64-390.77.run --accept-license -q -X
