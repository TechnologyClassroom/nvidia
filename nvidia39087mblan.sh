...
# sudo bash nvidia39087mblan.sh
# OR
# su
# bash nvidia39087mblan.sh
# OR
# sudo chmod 755 nvidia39087mblan.sh
# sudo ./nvidia39087mblan.sh
# OR
# su
# chmod 755 nvidia39087mblan.sh
# ./nvidia39087mblan.sh
...
if [[ $(which dkms | wc -l) -gt 0 ]]; then
  sh NVIDIA-Linux-x86_64-390.87.run --accept-license -q --dkms --no-opengl-files
else
  sh NVIDIA-Linux-x86_64-390.87.run --accept-license -q --no-opengl-files
fi
echo \ 
