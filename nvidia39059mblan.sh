...
# nvidia39059mblan.sh
# Michael McMahon
# This script installs proprietary NVIDIA drivers 390.59 and CUDA toolkit
# for motherboard video output.

# To run this script, boot into your GNU/Linux distro with runlevel 2 or 3.
# Follow these instructions:
# Run this script with:
# sudo bash nvidia39059mblan.sh
# OR
# su
# bash nvidia39059mblan.sh
# OR
# sudo chmod 755 nvidia39059mblan.sh
# sudo ./nvidia39059mblan.sh
# OR
# su
# chmod 755 nvidia39059mblan.sh
# ./nvidia39059mblan.sh
...
wget -q ftp://10.12.17.15/pub/software/drivers/nvidia/NVIDIA-Linux-x86_64-390.59.run
# wget -q http://us.download.nvidia.com/XFree86/Linux-x86_64/390.59/NVIDIA-Linux-x86_64-390.59.run
...
if [[ $(which dkms | wc -l) -gt 0 ]]; then
  sh NVIDIA-Linux-x86_64-390.59.run --accept-license -q --dkms --no-opengl-files
else
  sh NVIDIA-Linux-x86_64-390.59.run --accept-license -q --no-opengl-files
fi
...
# installer.
#   sh NVIDIA-Linux-x86_64-390.59.run --accept-license -q -X
