...
# sudo bash nvidia41066mblan.sh
# OR
# su
# bash nvidia41066mblan.sh
# OR
# sudo chmod 755 nvidia41066mblan.sh
# sudo ./nvidia41066mblan.sh
# OR
# su
# chmod 755 nvidia41066mblan.sh
# ./nvidia41066mblan.sh
...
if [[ $(which dkms | wc -l) -gt 0 ]]; then
  sh NVIDIA-Linux-x86_64-410.66.run --accept-license -q --dkms --no-opengl-files
else
  sh NVIDIA-Linux-x86_64-410.66.run --accept-license -q --no-opengl-files
fi
echo \ 
