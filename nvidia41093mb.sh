...
# sudo bash nvidia41093mb.sh
# OR
# su
# bash nvidia41093mb.sh
# OR
# sudo chmod 755 nvidia41093mb.sh
# sudo ./nvidia41093mb.sh
# OR
# su
# chmod 755 nvidia41093mb.sh
# ./nvidia41093mb.sh
...
if [ "$BASH_VERSION" = '' ]; then
  ...
  echo "sudo bash nvidia41093mb.sh"
  exit 1
fi
