...
# sudo bash nvidia41097mb.sh
# OR
# su
# bash nvidia41097mb.sh
# OR
# sudo chmod 755 nvidia41097mb.sh
# sudo ./nvidia41097mb.sh
# OR
# su
# chmod 755 nvidia41097mb.sh
# ./nvidia41097mb.sh
...
if [ "$BASH_VERSION" = '' ]; then
  ...
  echo "sudo bash nvidia41097mb.sh"
  exit 1
fi
