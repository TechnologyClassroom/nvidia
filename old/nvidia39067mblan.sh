...
# sudo bash nvidia39067mblan.sh
# OR
# su
# bash nvidia39067mblan.sh
# OR
# sudo chmod 755 nvidia39067mblan.sh
# sudo ./nvidia39067mblan.sh
# OR
# su
# chmod 755 nvidia39067mblan.sh
# ./nvidia39067mblan.sh
...
if [[ $(which dkms | wc -l) -gt 0 ]]; then
  sh NVIDIA-Linux-x86_64-390.67.run --accept-license -q --dkms --no-opengl-files
else
  sh NVIDIA-Linux-x86_64-390.67.run --accept-license -q --no-opengl-files
fi
