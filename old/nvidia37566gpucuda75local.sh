...
# nvidia37566gpucuda75local.sh
# Michael McMahon
# This script installs proprietary NVIDIA drivers 375.66 and CUDA 7.5 toolkit
# for GPU video output.

# To run this script, boot into your GNU/Linux distro with runlevel 2 or 3.
# Follow these instructions:
# Run this script with:
# sudo bash nvidia37566gpucuda75local.sh
# OR
# su
# bash nvidia37566gpucuda75local.sh
# OR
# sudo chmod 755 nvidia37566gpucuda75local.sh
# sudo ./nvidia37566gpucuda75local.sh
# OR
# su
# chmod 755 nvidia37566gpucuda75local.sh
# ./nvidia37566gpucuda75local.sh
...
if [[ $(which dkms | wc -l) -gt 0 ]]; then
  sh NVIDIA-Linux-x86_64-375.66.run --accept-license -q --dkms -X -Z --ui=none -s
else
  sh NVIDIA-Linux-x86_64-375.66.run --accept-license -q -X -Z --ui=none -s
  # sh NVIDIA-Linux-x86_64-375.66.run --accept-license -q -X -Z
fi
echo \ 
...
sh cuda_7.5.18_linux.run --toolkit --silent --override
