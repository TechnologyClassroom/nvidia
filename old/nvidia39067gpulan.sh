...
# nvidia39067gpulan.sh
# Michael McMahon
# This script installs proprietary NVIDIA drivers 390.67 and CUDA toolkit
# for GPU video output.

# To run this script, boot into your GNU/Linux distro with runlevel 2 or 3.
# Follow these instructions:
# Run this script with:
# sudo bash nvidia39067gpulan.sh
# OR
# su
# bash nvidia39067gpulan.sh
# OR
# sudo chmod 755 nvidia39067gpulan.sh
# sudo ./nvidia39067gpulan.sh
# OR
# su
# chmod 755 nvidia39067gpulan.sh
# ./nvidia39067gpulan.sh
...
wget -q ftp://10.12.17.15/pub/software/drivers/nvidia/NVIDIA-Linux-x86_64-390.67.run
# wget -q http://us.download.nvidia.com/XFree86/Linux-x86_64/390.67/NVIDIA-Linux-x86_64-390.67.run
...
# sh NVIDIA-Linux-x86_64-390.67.run --accept-license -q -X -Z
sh NVIDIA-Linux-x86_64-390.67.run --accept-license -q -X -Z --ui=none -s
echo \ 
...
# installer.
#   sh NVIDIA-Linux-x86_64-390.67.run --accept-license -q -X
