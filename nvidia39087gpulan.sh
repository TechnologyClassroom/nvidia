...
# nvidia39087gpulan.sh
# Michael McMahon
# This script installs proprietary NVIDIA drivers 390.87 and CUDA toolkit
# for GPU video output.

# To run this script, boot into your GNU/Linux distro with runlevel 2 or 3.
# Follow these instructions:
# Run this script with:
# sudo bash nvidia39087gpulan.sh
# OR
# su
# bash nvidia39087gpulan.sh
# OR
# sudo chmod 755 nvidia39087gpulan.sh
# sudo ./nvidia39087gpulan.sh
# OR
# su
# chmod 755 nvidia39087gpulan.sh
# ./nvidia39087gpulan.sh
...
wget -q ftp://10.12.17.15/pub/software/drivers/nvidia/NVIDIA-Linux-x86_64-390.87.run
# wget -q http://us.download.nvidia.com/XFree86/Linux-x86_64/390.87/NVIDIA-Linux-x86_64-390.87.run
...
if [[ $(which dkms | wc -l) -gt 0 ]]; then
  sh NVIDIA-Linux-x86_64-390.87.run --accept-license -q --dkms -X -Z --ui=none -s
else
  sh NVIDIA-Linux-x86_64-390.87.run --accept-license -q -X -Z --ui=none -s
  # sh NVIDIA-Linux-x86_64-390.87.run --accept-license -q -X -Z
fi
echo \ 
...
# installer.
#   sh NVIDIA-Linux-x86_64-390.87.run --accept-license -q -X
